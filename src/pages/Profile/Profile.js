...
const Profile = () => {
  ...
  //mostra ou oculta o formulario de edição de imagem
  // Show or hide forms
  ...
  // carrega os dados para o formulario da foto escolhida
  const handleEdit = (photo) => {
    //verifica se o formulario está escondido se sim o mostra e oculta o formulario de cadastro
